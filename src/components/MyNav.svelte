...
<style>
  * {
  ...
  .nav-list li {
    display: flex;
    list-style: none;
    min-width: var(--list-item-h-width);
    min-height: 2rem;
  ...
  @media only screen and (max-width: 600px) {
    .nav-list {
      ...
      -webkit-transition: right 0.5;
    }
    .nav-list li {
      min-width: var(--list-item-v-width);
    }
    #nav-icon {
...
<nav>
  <div id="logo"><img src="https://qubit-bucket.s3.eu-west-2.amazonaws.com/images/qubit_480_white.png" height="65px" alt="Logo"></div>
  ...
  <div id="nav-icon" class={open ? 'open' : ''} on:click={toggleIcon}>
    <div />
    <div />
    <div />
  </div>
